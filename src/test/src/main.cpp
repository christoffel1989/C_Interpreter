...
TEST(test_definitionn, primitive_var_and_function)
{
    ...
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("f2(a, 4)")), &GlobalEnv).value_or(0), 5);
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("g(f2, 3, 4)")), &GlobalEnv).value_or(0), 6);
}
...
TEST(test_definitionn, array_and_loop)
{
    ...
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("sum(arr, 10)")), &GlobalEnv).value_or(0), 55);
}
...
TEST(test_recursive_function, frac)
{
    ...
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("frac(6)")), &GlobalEnv).value_or(0), 720);
}
...
TEST(test_recursive_function, fibbo)
{
    ...
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("fib(7)")), &GlobalEnv).value_or(0), 13);
}
...
TEST(test_pointer, reference_and_dereference)
{
    ...
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("a;")), &GlobalEnv).value_or(0), 4);
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("b;")), &GlobalEnv).value_or(0), 3);
}
...
TEST(test_pointer, self_increment_and_decrement)
{
    ...
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("a;")), &GlobalEnv).value_or(0), 6);
    interpreteAST(std::get<0>(createStatementASTNode("*pb = a++;")), &GlobalEnv);
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("b;")), &GlobalEnv).value_or(0), 6);
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("a;")), &GlobalEnv).value_or(0), 7);
}
...
TEST(test_others, scope_hidden)
{
    ...
    EXPECT_EQ(interpreteAST(std::get<0>(createStatementASTNode("fun();")), &GlobalEnv).value_or(0), 2);
}